...
<script type="text/javascript" src="../../libs/tiny_mce/jquery.tinymce.js"></script>
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-2">Galeria</a><img src="../img/ico-salvar.gif" width="8" height="8" alt="atualizado!" title="Não esqueça de salvar!" class="ico-atualizar" /></li>
	</ul>
	<div id="tabs-1"><!--ABA == 1-->
	...
	<div id="tabs-2"><!--ABA == 2-->
    	...
    	<p><img src="../img/ico-addfoto.png" alt="+ foto" width="18" height="18" align="left" style="margin-top:5px; margin-right:5px;" />
        ...
        <!--se não imagens-->
        <div class="como-editar-img" align="center" style="clear:both;"><img src="../img/como_editar_img.jpg" width="621" height="214" alt="como editar imagens" /></div>
        <!--se não imagens-->
        
        <ul id="galeria">
        
        <!--unidade de manipular fotos-->
        <li class="unidade-foto" id="id1">
        <div class="drag">1</div>
        <div class="crop">
        	<div class="controle"><a href="#">Zoom</a><br /><a href="#">Editar</a><br /><a href="#" class="remover-img">Remover</a></div>
        	<div class="img"><img src="../img/ico-addfoto.png" width="110" height="90" alt=" " /></div>            
        </div>
        ...
        <!--unidade de manipular fotos fim-->
         <!--unidade de manipular fotos-->
        <li class="unidade-foto" id="id2">
        <div class="drag">2</div>
        <div class="crop">
        	<div class="controle"><a href="#">Zoom</a><br /><a href="#">Editar</a><br /><a href="#" class="remover-img">Remover</a></div>
        	<div class="img"><img src="../img/ico-addfoto.png" width="110" height="90" alt=" " /></div>            
        </div>
        <div class="desc"><textarea name="descricao" cols="" rows="" class="descricao focus">descreva...</textarea></div>
        <div class="confirma">Confirma?<br /><a href="#" class="nao-confirma">não</a></div>
        </li>
        <!--unidade de manipular fotos fim-->
         <!--unidade de manipular fotos-->
        <li class="unidade-foto" id="id3">
