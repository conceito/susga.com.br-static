...
?>
      ...
      <?php if($listOptions['sortable']) echo '<td valign="top" class="dragme"></td>'?>
        ...
        <td valign="top"><?php echo barra_edicao($edicao, $row['nome']);?>
        </td>
        <td valign="top"><?php echo $row['apelido'];?></td>
        <td valign="top"><?php echo $row['tipo'];?></td>
        <td valign="top"><?php echo $row['ultima'];?></td>
