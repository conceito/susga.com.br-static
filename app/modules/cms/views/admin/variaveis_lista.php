...
?>
      ...
      <?php if($listOptions['sortable']) echo '<td valign="top" class="dragme"></td>'?>
        ...
        <td valign="top"><?php echo barra_edicao($edicao, $row['titulo'], 'variaveis');?>        
      
        </td>
        <td valign="top"><?php echo $row['ttlitem'];?></td>
         <td valign="top"><?php echo $row['resumo'];?></td>
