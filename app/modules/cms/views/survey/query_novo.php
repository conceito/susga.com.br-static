...
<div class="panel-left clearfix">
    ...
    <label for="titulo" class="lb-full"><b class="obr">[!]</b> Enunciado da pergunta</label><input name="titulo" id="titulo" type="text" class="input-longo input-titulo" value="<?php echo set_value('titulo');?>" />

    <br />

    <label for="" class="lb-full"><b class="obr">[!]</b> Tipo de questão (não poderá ser alterado)</label>
    <?php echo (! $comboQueryTypes) ? '' : $comboQueryTypes?>
