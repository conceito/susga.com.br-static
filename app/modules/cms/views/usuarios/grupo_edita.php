...
<label for="nick_edita" class="lb-full">Apelido</label><input name="nick_edita" id="nick_edita" type="text" class="input-apelido" value="<?php echo $nick;?>" readonly="readonly" />
