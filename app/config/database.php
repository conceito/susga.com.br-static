...
$db['development']['database'] = 'meucms';
$db['development']['dbdriver'] = 'mysql';
$db['development']['dbprefix'] = '';
$db['development']['pconnect'] = TRUE;
$db['development']['db_debug'] = TRUE;
$db['development']['cache_on'] = FALSE;
$db['development']['cachedir'] = 'app/cache';
...
$db['testing']['username'] = 'brunob_cms3';
$db['testing']['password'] = '123456';
$db['testing']['database'] = 'brunob_cms3';
...
$db['production']['username'] = 'brunob_cms3';
$db['production']['password'] = '123456';
$db['production']['database'] = 'brunob_cms3';
